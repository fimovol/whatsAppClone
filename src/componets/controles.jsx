...
export default function _(){
  return <div className="bg-orange-100 w-full h-20 flex items-center">
    <div className="w-1/2 ml-2">
      <Fotoperfil/>
    </div>
    <div className="w-1/2 flex items-center justify-end space-x-6 mr-2">
      <Estados/>
      <NuevoChat/>
      <Menu/>
    </div>
...
function Estados(){
  return <span data-testid="status-v3" data-icon="status-v3" className="">
    <svg version="1.1" id="ee51d023-7db6-4950-baf7-c34874b80976" x="0" y="0" viewBox="0 0 24 24" width="35" height="35" className="">
...
function NuevoChat(){
  return <span data-testid="chat" data-icon="chat" className="">
    <svg viewBox="0 0 24 24" width="35" height="35" className="">
...
function Menu(){
  return <span data-testid="menu" data-icon="menu" className="">
    <svg viewBox="0 0 24 24" width="35" height="35" className="">
